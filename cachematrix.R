# makeCacheMatrix is a "function" that declares a bunch of properties for an "object".
makeCacheMatrix <- function(x = matrix()) {
        ...
        # setter assigns inverse to inv on the upper level context
        setInverse <- function(inverse) inv <<- inverse
        
        # getter just returns the variable inv
...
# cacheSolve is the function which will return the inverse
...
cacheSolve <- function(x, ...) {
        ...
        if (is.null(inv)) {
                ...
                message("the data is cached") # else part is to show the data returned is the cached one...
        }
